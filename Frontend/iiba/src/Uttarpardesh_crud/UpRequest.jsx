...
const UpRequest = () => {
     const navigate = useNavigate();
      ...
      const acceptRequest = async (e) => {
        ...
        const Senddata = await fetch("http://localhost:4500/Add_Uttarparadesh_Member", {
      ...
      const DeleteRequest = async (e) => {
        ...
        if (confirm("Are You Sure Decline The Request!")) {
          const data = await fetch(`http://localhost:4500/deleteUpRequest/${e}`, {
            method: "delete"
          })
