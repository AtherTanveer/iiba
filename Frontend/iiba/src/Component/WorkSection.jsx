...
const WorkSection = () => {
  return (
    <>
      <Helmet>
        <title>
          IIBA Work & Contributions | Indian Industries & Business Association
        </title>

        <meta
          name="description"
          content="Explore the work and contributions of Indian Industries & Business Association (IIBA) in infrastructure development, government collaboration, industrial support and economic growth across multiple states in India."
        />

        <meta
          name="keywords"
          content="IIBA work, infrastructure development India, industry association India, government projects, business support organization, industrial development association"
        />
